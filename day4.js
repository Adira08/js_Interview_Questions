...
// Ans.> it is period of time during which let and const declaration can not be access. It ia area of block where veriables are not accessable untill the moment computer completely initializes it with a value.

// A block is a pair of braces ({...}) used to group multiple statements.
// Initialization occers when you assign an initial value to a veriable.

// =========================================================================

// Q2 // What is the for-in loop in Javascript? Give its syntax
// Ans.> It itterate over properties.       
        // like if we use object it will give the output as all key present in the object and if we  use it in array it will give use the index value of the array
// let obj = {
//     name: "Aditya",
//     lastName: "Raj",
//     age: 25,
// };
// let array = ["Aditya", "Rishi", "Ashish"];

// for (let i in obj){                 //for object i will give the keys
//     console.log(i);
// }

// for (let i in array){               //for arrays it will give the index number
//     console.log(i);
// }
